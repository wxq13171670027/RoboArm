...
def read_trajectory(file_path):
    ...
    with open(file_path, 'r') as f:
        ...
        for line in f:
            # 将每行的字符串分割并转换为浮点数
            x, y, z, rx, ry, rz = map(float, line.strip().split())
            # 添加默认的姿态角度
           # rx, ry, rz = 0, 90, 0  # TODO:设置末端执行器的姿态角度（路径跟踪与轨迹规划规划的要求不同）
...
def main():
    ...
    '''
    # 从文件中读取轨迹数据
    trajectory = read_trajectory('cobot_poses_20251221_185643.txt')  #TODO:替换成自己的路径
